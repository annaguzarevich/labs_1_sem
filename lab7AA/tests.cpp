...
StudentAfter2ndTerm studentAfter2NdTerm("Anna",2,3,34,grades,grades1);
...
StudentAfter1stTerm stTerm("Anna", 2, 4, 34, grades);
StudentAfter2ndTerm studentAfter2NdTerm("Anna", 2, 4, 34, grades, grades1);
vector<Student*> st;
...
StudentAfter1stTerm stTerm("Anna", 2, 4, 34, grades);
StudentAfter2ndTerm studentAfter2NdTerm("Anna", 2, 2, 34, grades, grades1);
vector<Student*> st;
...
StudentAfter1stTerm stTerm("Anna", 2, 5, 34, grades);
StudentAfter2ndTerm studentAfter2NdTerm("Anna", 2, 2, 34, grades, grades1);
vector<Student *> st;
